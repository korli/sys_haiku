...
func Mlock(b []byte) (err error) {
	...
	_, _, e1 := sysvicall6(uintptr(unsafe.Pointer(&libc_Mlock)), 2, uintptr(unsafe.Pointer(_p0)), uintptr(len(b)), 0, 0, 0, 0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
	return
...
func Mprotect(b []byte, prot int) (err error) {
	...
	_, _, e1 := sysvicall6(uintptr(unsafe.Pointer(&libc_Mprotect)), 3, uintptr(unsafe.Pointer(_p0)), uintptr(len(b)), uintptr(prot), 0, 0, 0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
	return
...
func Munlock(b []byte) (err error) {
	...
	_, _, e1 := sysvicall6(uintptr(unsafe.Pointer(&libc_Munlock)), 2, uintptr(unsafe.Pointer(_p0)), uintptr(len(b)), 0, 0, 0, 0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
	return
